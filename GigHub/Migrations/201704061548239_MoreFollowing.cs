namespace GigHub.Migrations
{
    ...
    public partial class MoreFollowing : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Followings", "FoloweeId");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Followings", "FoloweeId", c => c.String(nullable: false, maxLength: 128));
            DropPrimaryKey("dbo.Followings");
            AddPrimaryKey("dbo.Followings", new[] { "FollowerId", "FoloweeId" });
